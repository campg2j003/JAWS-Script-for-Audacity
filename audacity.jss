...
Const CS_SCRIPT_VERSION = "2.2.2-beta-2020-07-04"
;Last updated 2020-07-04T20:54Z
...
Let s2 = StringReplaceSubstrings(s2, CS_SYNCLOCKED, "")
Return s2
...
If !iRtn Then
	...
	;MSAA mode has already been saved and set.
	Let obj = GetObjectFromEvent(hWnd, -4, 0, iTemp)
	If obj Then
