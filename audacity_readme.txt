8/10/2012 JAWS script for Audacity V1.0 by Gary Campbell <campg2003@gmail.com>
;Modification
...
Speaks alert messages with some default hotkeys. Read the what's new.txt for mor information.
...
The hotkeys of 4 scripts above replaced the default Jaws mouse movement scripts. If you want to activate the original functionality, please turn on Jaws
cursor while focus in the main window.
To toggle speech on or off, press shift+jawskey+s.
To toggle alert message on or off, press Control+`). See the what new.txt for mor info.
